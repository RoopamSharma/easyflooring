...
<div class="main">
	...
	<div class="main-inner">
	    ...
	    <div class="container">
	  	  ...
	  	  <!-- /row -->	
                <form id="edit-profile" class="form-horizontal"  action="projectaction.php" method="POST" enctype="multipart/form-data">
	      <div class="row">
	      	...
	      	<div class="span8.5">
	      		...
	      		<div class="widget">
					...
					<div class="widget-content">
                          <?php $querycurr=mysql_query("SELECT * FROM project");
						  $row = mysql_fetch_array($querycurr);
						  ?>
                    	<textarea id ="name" name="name" > <?php echo $row['name'];?></textarea>
