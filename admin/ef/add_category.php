    ...
    <div class="container">
        ...
        <div class="widget ">
            ...
            <ul class="nav nav-tabs">
              <li  class="active">
                <a href="#formcontrols" data-toggle="tab">Edit Categories</a>
              </li>
            </ul>
            <br>
           ...
           <?php 
		  $catquery=mysql_query("select * from maincategory");
		  $i=1;
		$total=mysql_num_rows($catquery);
        while( $i<=$total)
		{
		$catrow = mysql_fetch_array($catquery);
		$string[$i]=$catrow['mcatname'];
		$index[$i]=$catrow['mcatid'];
		$i++;
		}
		for($i=1;$i<=$total;$i++)
			{
			$delid=$index[$i];
   			 echo $string[$i];		
		      ?>
          <a href="delcat.php?id=<?php echo $delid ?>">Delete Category</a>
          <?php      
		  echo "<br/>";
		  }
		  ?>
                ...
                <form id="edit-profile" class="form-horizontal"  action="add_category.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="left">               
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <select name ="mid" name="users" onchange="showUser(this.value)" >
                ...
                <form id="edit-profile" class="form-horizontal"  action="add_category.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="left">               
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <select name ="mpid" name="users" onchange="showUser1(this.value)">
                        <option value="">Select Main-Category</option>
                        <?php  
