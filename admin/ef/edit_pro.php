...
if(isset($_POST['psubmit'])) {
  $query1 = mysql_query("update products set proname='$_POST[pname]' ,prodesc='$_POST[editor1]'  where proid='$_POST[pid]' ");
...
<div class="main">
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              ...
              <a href="add_category.php" class="shortcut"><i class="shortcut-icon icon-list-alt"></i><span class="shortcut-label">Add Category</span> </a>
               ...
               <a href="add_pro.php" class="shortcut"><i class="shortcut-icon icon-headphones"></i><span class="shortcut-label">Add Products</span> </a>
              <!-- /shortcuts --> 
            </div>
            <!-- /widget-content --> 
          </div>
              ...
              <div class="tab-content">
                ...
                <form id="edit-profile" class="form-horizontal"  action="edit_pro.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="left">  
                        ...
                        <?php
                        $sql2="SELECT * FROM products where proid = '".$_GET['id']."'";
                         echo '<br> <label class="control-label" align>Product Id</label>';
 ...
 while ($row2= mysql_fetch_assoc($result2)) {
           			  echo' </br> <label class="control-label" align>Product Name</label>';
					  //echo "</br>";
                       echo' <div class="controls">';
                       echo' <input type="text" class="span6" name="pname" value="'.$row2["proname"].'" >';
                     echo' </div></br>';

                      echo'  <label class="control-label">Description</label>';
                       echo' <div class="controls">';
                    echo '<textarea  id ="editor1" name="editor1">';
					echo $row2["prodesc"];
					echo "</textarea>";
                            echo' </div></br>';  
