        ...
        <div class="widget ">
           ...
           <div class="tabbable">
            ...
            <ul class="nav nav-tabs">
              <li  class="active">
              <li ><a href="#editproducts" data-toggle="tab">Our Projects</a></li>
              </li>
            </ul>
            <br>
                ...
                <div class="tab-pane active" id="editproducts">
                  ...
                  <div class="left">               
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <?php
                                               $res = mysql_query("select * from project;");
                                                          while ($row= mysql_fetch_assoc($res)) {
                echo'<form id="edit-profile" class="form-vertical"  action="edit_project.php" method="POST" enctype="multipart/form-data">';

                                                  echo'  <div class="alert alert-success">';
                                              echo'<button type="button" class="close"  name="del"><a href="abc1.php?id='. $row["id"] .'" style="text-decoration:none;">&times;</button>';
                                              echo'<button type="button" class="close" name="edit"><a href="e_project.php?id='. $row["id"] .'" style="text-decoration:none;">&#9997;</a></button>';
                                                            echo $row['name'] ;
                                                            echo '</div>';
                                                            echo '</form>';
                                                          }
        ...
        <div class="span6">
          <div class="widget" style="width:500px;">
            <div class="widget-header"> <i class="icon-bookmark"></i>
              <h3>Modify Projects</h3>
            </div>
            <!-- /widget-header -->
            <div class="widget-content style="width:500px;"">
              <div class="shortcuts"> 
               <a href="edit_project.php" class="shortcut"><i class="shortcut-icon icon-headphones"></i><span class="shortcut-label">Add Project</span> </a>
              <!-- /shortcuts --> 
            </div>
            <!-- /widget-content --> 
          </div>
