...
function showdet(str){
    if (str == "") {
        ...
        xmlhttp.open("GET","pqr.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
                ...
                <div class="tab-pane active" id="jscontrols">
                    <fieldset>
                      ...
                      <label class="control-label">Choose Main Category </label>
                                                          ...
                                                          <select name ="mcid" onChange="showdet(this.value)">
                                                          <option value="0">Select Main-Category</option>
														  <?php  
                                                          
														  $res = mysql_query("select * from maincategory;");
                                                          while ($row= mysql_fetch_assoc($res)) {
                                                            echo '<option name="main" value="'.$row["mcatid"] .'">'.$row["mcatname"] .'</option>';
                                                          }
                ...
                <form id="edit-profile" class="form-horizontal"  action="add_subcat.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="left">               
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <select name ="mid"  name="users" onchange="showdet(this.value)" >
