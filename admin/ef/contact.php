...
<li>
        ...
        <li class="active"><a href="contact.php"><i class="icon-comments"></i><span>Contatct</span> </a> </li>
			</ul>
	      	...
	      	<div class="span9">
	      		<div class="widget">
					...
					<div class="widget-content">
                     ...
                     <?php $querycurr=mysql_query("SELECT cont FROM contact where id='1'");
...
if(!(empty($contact))){  
	 $queryc = mysql_query("update contact set cont='$contact' where id='1'");	
	 }
	 ?>
